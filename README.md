...
Проект реализует классическую архитектуру **DWH (Data Warehouse)**: автоматизированный сбор сырых данных (Ingestion), очистку и дедупликацию в промежуточном слое (Staging), а также построение аналитических витрин (Data Marts) с использованием сложных оконных функций SQL для визуализации в BI-системе.
...
* **ОС / Окружение:** Linux (Ubuntu / WSL2)
